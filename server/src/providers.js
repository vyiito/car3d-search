export const providers = [
  ...
  { id: 'moddb', name: 'ModDB', type: 'game-mods', baseUrl: 'https://www.moddb.com', buildUrl: q => `https://www.moddb.com/search?q=${encodeURIComponent(`${q} car vehicle`)}` },
  ...
  { id: 'vk-3d-car-models', name: 'VK · 3D Car Models', type: '3d-models', baseUrl: 'https://vk.ru', adapter: 'collection', collectionUrl: 'https://vk.ru/3d_car_models', buildUrl: () => 'https://vk.ru/3d_car_models' },
  { id: '3dwarehouse', name: 'SketchUp 3D Warehouse', type: '3d-models', baseUrl: 'https://3dwarehouse.sketchup.com', buildUrl: q => `https://3dwarehouse.sketchup.com/search/?q=${encodeURIComponent(`${q} car vehicle`)}` },
]
